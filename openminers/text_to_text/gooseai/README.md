...
```
python3 -m pip install -r openminers/text_to_text/gooseai/requirements.txt 
python3 openminers/text_to_text/gooseai/miner.py --gooseai.api_key <your GooseAI api_key>
```

# Full Usage
```
usage: miner.py [-h] --gooseai.api_key GOOSEAI.API_KEY [--gooseai.model_name GOOSEAI.MODEL_NAME]
