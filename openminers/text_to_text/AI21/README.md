...
# Example Usage
```
python3 -m pip install -r openminers/text_to_text/AI21/requirements.txt 
python3 openminers/text_to_text/AI21/miner.py --ai21.api_key <your AI21 api_key>
```

# Full Usage
```
usage: miner.py [-h] --ai21.api_key AI21.API_KEY [--ai21.model_name AI21.MODEL_NAME] [--ai21.stop AI21.STOP] [--netuid NETUID]
                 [--miner.name NEURON.NAME] [--miner.blocks_per_epoch NEURON.BLOCKS_PER_EPOCH] [--miner.no_set_weights]
