...
# Example Usage
```
python3 -m pip install -r openminers/text_to_text/cohere/requirements.txt
python3 openminers/text_to_text/cohere/miner.py --cohere.api_key <your cohere API key>
```

# Full Usage
```
usage: miner.py [-h] [--cohere.model_name COHERE.MODEL_NAME] [--cohere.max_tokens COHERE.MAX_TOKENS]
