## Instructor Text to Embedding Miner
Miner for serving a text to embedding miner.

# Example Usage
```
python3 -m pip install -r openminers/text_to_embedding/miners/instructor/requirements.txt 
python3 openminers/text_to_embedding/miners/instructor/miner.py 
```

# Full Usage
```
usage: miner.py [-h] [--model_name MODEL_NAME] [--chunk_length_s CHUNK_LENGTH_S] [--device DEVICE] [--netuid NETUID] [--neuron.name NEURON.NAME] [--neuron.blocks_per_epoch NEURON.BLOCKS_PER_EPOCH]
