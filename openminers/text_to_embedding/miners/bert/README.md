...
# Requirements
```bash
python -m pip install -r openminers/text_to_embedding/miners/bert-base-cased/requirements.txt
```

# Usage
```bash
python openminers/text_to_embedding/miners/bert-base-cased/miner.py
```
